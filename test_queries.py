...
test_plans = []
if USE_BAO:
    os.system("cd bao_server && /data1/linliang/anaconda3/envs/py310/bin/python3 baoctl.py --load /data1/linliang/Bao/BaoForPostgreSQL/bao_server/bao_train_model_256")
    os.system("sync")
...
result_file_path_test = '/data1/linliang/Bao/BaoForPostgreSQL/data/bao_test_13k.json'
